...
Our website is designed to give individuals with intellectual disabilities an easy and clear way to express their needs. By clicking on icons representing common requests, such as:
...
Customizable Icons: Ability to add or modify icons to cater to the user’s personal needs.
Categorized Icons: Organize icons into clear categories like "Basic Needs", "Emotions", "Activities", etc.
...
Message Details: The notification could include the icon selected and the time, and a short description of the need.

#### Multi-Language Support
Text-to-Speech: Text on icons can be read aloud to assist those with vision or reading difficulties.

#### User Profiles and Customization
Personalized Profiles: Each user can have their own account with custom preferences, which includes favorite or frequently used icons.
Caregiver Access: Caregivers can view and manage messages, receive notifications, and track user activity.
...
Audio Feedback: Provides visual confirmation that reads the need out load.
